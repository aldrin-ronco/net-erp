...
namespace NetErp.Inventory.StockMovementsOut.ViewModels
{
    ...
    /// </summary>
    public class StockMovementOutCancelDialogViewModel : Screen
    {
        ...
        public StockMovementOutCancelDialogViewModel(
        ...
        public async Task ConfirmAsync()
        {
            ...
            {
                IsBusy = true;
                var (fragment, query) = StockMovementOutQueries.CancelMovement.Value;
