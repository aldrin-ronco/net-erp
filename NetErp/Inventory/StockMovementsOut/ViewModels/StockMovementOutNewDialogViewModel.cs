...
{
    /// <summary>
    /// Modal para crear el draft inicial de un Stock Movement de salida.
    ...
    /// </summary>
    public class StockMovementOutNewDialogViewModel : Screen
    {
        ...
        public StockMovementOutNewDialogViewModel(
        ...
        protected override async void OnViewReady(object view)
        {
            ...
            try
            {
                ...
                await Task.WhenAll(
                    ...
                    _outboundAccountingSourceCache.EnsureLoadedAsync(),
        ...
        public async Task SaveAsync()
        {
            ...
            {
                IsBusy = true;
                var (fragment, query) = StockMovementOutQueries.CreateDraft.Value;
