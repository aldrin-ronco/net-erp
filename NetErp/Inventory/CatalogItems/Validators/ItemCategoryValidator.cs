...
{
    /// <summary>
    /// Lógica de validación pura para ItemCategory.
    /// </summary>
    public class ItemCategoryValidator
    {
        public IReadOnlyList<string> Validate(string propertyName, string? value, ItemCategoryValidationContext context)
        {
        ...
        public Dictionary<string, IReadOnlyList<string>> ValidateAll(ItemCategoryValidationContext context)
        {
        ...
        public bool CanSave(ItemCategoryCanSaveContext context)
        {
    ...
    public class ItemCategoryValidationContext
    {
        public string? Name { get; init; }
    }

    public class ItemCategoryCanSaveContext
    {
