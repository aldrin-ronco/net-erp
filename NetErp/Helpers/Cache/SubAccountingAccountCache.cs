...
{
    /// <summary>
    /// Cache para subcuentas contables (código de 6 dígitos, AccountLevel = 4).
    /// </summary>
    public class SubAccountingAccountCache : IEntityCache<AccountingAccountGraphQLModel>, IBatchLoadableCache,
        ...
        IHandle<AccountingAccountDeleteMessage>
    {
        ...
        public SubAccountingAccountCache(
        ...
        public async Task EnsureLoadedAsync()
        {
            ...
            try
            {
                ...
                var variables = new GraphQLVariables()
                    ...
                    .For(fragment, "filters", new { AccountLevel = 4 })
                    .Build();
        ...
        public void ApplyVariables(GraphQLVariables variables, GraphQLQueryFragment batchFragment)
        {
            ...
            variables.For(batchFragment, "filters", new { AccountLevel = 4 });
        }
        ...
        public Task HandleAsync(AccountingAccountCreateMessage message, CancellationToken cancellationToken)
        {
            if (message.CreatedAccountingAccount != null &&
                ...
                message.CreatedAccountingAccount.Code.Length == 6)
            {
        ...
        public Task HandleAsync(AccountingAccountUpdateMessage message, CancellationToken cancellationToken)
        {
            ...
            if (account != null)
            {
                bool isSubAccount = !string.IsNullOrEmpty(account.Code) && account.Code.Length == 6;
