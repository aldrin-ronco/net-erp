...
namespace NetErp.Helpers
{
    ...
    public static class PermissionCodes
    {
        ...
        {
            private const string Prefix = "seller";
        ...
        {
            private const string Prefix = "supplier";
        ...
        {
            private const string Prefix = "price_list";
        ...
        {
            private const string Prefix = "promotion";
        ...
        public static class StockMovementIn
        {
            private const string Prefix = "stock_movement_in";
        ...
        {
            private const string Prefix = "item_brand";
        ...
        public static class AccountingAccount
        {
            private const string Prefix = "accounting_account";
        ...
        {
            private const string Prefix = "user_permission";

            public const string Edit = $"{Prefix}.edit";
            public const string BatchAssign = $"{Prefix}.batch_assign";
        }
