...
{
    /// <summary>
    /// Interface base para todos los Panel Editors del módulo Treasury Masters.
    ...
    /// </summary>
    public interface ITreasuryMastersPanelEditor : INotifyPropertyChanged, INotifyDataErrorInfo
    {
        #region Estado
        ...
        /// </summary>
        /// <param name="context">Contexto necesario (ej: CostCenterId para CashDrawer).</param>
